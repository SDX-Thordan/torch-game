...
| metric | value |
| --- | --- |
| bindings exposed | 320 |
| wired by the shell | 262 (81%) |
...
- **[NOTE]** _UI · coverage_ — The shell wires 81% of the 320 exposed bindings; 58 are never referenced (e.g. ["admin_load", "alert_threshold", "ally_count", "alpha", "blueprint_discover", "blueprint_known_count"]). Some are deliberately read-only or future, but a verb the shell never calls is a capability the player can't reach.
