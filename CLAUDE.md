...
- [ ] **Process & CI** — CLAUDE.md, PR CI workflow. *(this PR)*
- [ ] **APK skeleton** — Vite web entry + Capacitor Android + release workflow
  producing an APK artifact. De-risks the build pipeline early.
